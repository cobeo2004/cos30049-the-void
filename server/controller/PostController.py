...
class Controller:
    ...
    async def add_post(self, model: Annotated[Model, Doc("The Post Model")], db: Annotated[Prisma, Doc("The Prisma client instance")]):
    ...
    async def update_post(self, item_id: Annotated[int, Doc("The id to be update")], model: Annotated[Model, Doc("The new updated model")], db: Prisma):
