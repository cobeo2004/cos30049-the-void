...
class DataProcessing:
    ...
    def __init__(self) -> None:
        ...
        # Load the scaler and encoder used in training
        self.scaler = joblib.load('F:\\SwinburneV\\COS30049 - Computing Technology Innovation Project\\AI Integration\\cos30049-the-void\\Assignment2\\codes\\mode\\scaler.joblib')
        self.encoder = joblib.load('F:\\SwinburneV\\COS30049 - Computing Technology Innovation Project\\AI Integration\\cos30049-the-void\\Assignment2\\codes\\mode\\encoder.joblib')
    ...
    def process_data(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        data['flight_duration_in_minutes'] = (
            data['Arrival_datetime'] - data['Departure_datetime']).dt.total_seconds() / 60
        ...
        data['departure_date_distance'] = (
            data['Departure_datetime'].dt.date - today.date()).days
        ...
        if 'Stops' not in data.columns:
            ...
            data['stops'] = data['Stops'].replace(
                {'direct': 0, '1': 1, '2': 2}).astype(int)

        # Select relevant columns
        numerical_cols = ['flight_duration_in_minutes', 'year', 'day_of_month',
                            'month', 'day_of_week', 'departure_date_distance', 'stops']
